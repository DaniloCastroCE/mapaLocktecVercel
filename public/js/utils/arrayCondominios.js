const arrayCondominios = [
    ...
    {
      nome: "EDIFICIO CAROL (Em Implantação)",
      nomeSimplificado: "edificio carol (em implantacao)",
      lat: "-22.985109",
      lon: "-43.211462",
      ativo: true,
      tipo: "não definido",
...
export function getArrayCondominios() {
  return {
    array: arrayCondominios,
